...
Generated by `scripts/03_basic_eda.py` and saved to `visuals/tables/descriptive_stats.csv`.
...
Generated by `scripts/03_basic_eda.py` and saved to `visuals/tables/summary_stats_by_sentiment.csv`.
...
All figures below are generated by `scripts/03_basic_eda.py` and saved under `visuals/figures/`.

![Sentiment Distribution](../visuals/figures/sentiment_distribution.png)

![Word Count Distribution](../visuals/figures/word_count_distribution.png)

![Top 15 Most Frequent Words](../visuals/figures/top_words_by_sentiment.png)

![Correlation Matrix](../visuals/figures/correlation_matrix.png)

![Lexical Diversity vs Word Count](../visuals/figures/lexical_diversity_vs_wordcount.png)

![Lexical Diversity Segments](../visuals/figures/lexical_diversity_segments.png)
...
After step 4, the cleaned dataset will be at `data/processed/cleaned_data_set.csv`, all figures will be in `visuals/figures/`, and all tables will be in `visuals/tables/`.
...
| Summary statistics by sentiment | `visuals/tables/summary_stats_by_sentiment.csv` |
| Descriptive statistics | `visuals/tables/descriptive_stats.csv` |
| Six figures | `visuals/figures/*.png` |
